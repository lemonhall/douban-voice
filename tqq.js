...
var ifupdate_url=location.href.slice(0,15)=="http://t.qq.com";
...
var	getUserName = function(){
	...
	initVoiceAction=function(){
		...
		// 	<a href="#" class="txt sendPic" tabindex="3" 
		//    			title="支持单图、多图、截屏、长文转图、搜图等">
		// 		<em class="sico ico_pic"></em>
		// 		图片
		// 	</a>
		// </div>
		var uploadPic=$(".uploadPic");
		var div="<div class='sendList tqqVoice'>";
		var a="<a href='#'' class='txt sendPic' tabindex='3'"+ 
			  "title='语音微博'>";
		var em="<em class='sico ico_pic'"+ 
			   		"style='background:"+ 
			   		"url("+voice_img+")'>"+
			   "</em>语音";
		var final_html=div+a+em+"</a>"+"</div>";
			uploadPic.after(final_html);
			var voice_btn=$(".tqqVoice");
