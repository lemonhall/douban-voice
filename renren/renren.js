...
var	getUserName = function(){
	...
	initVoiceAction=function(){
		// <dd class='global-publisher-selector-video'>
		// 	<a class='global-publisher-video-trigger' 
		// 		href='javascript:;' title='视频'>
		// 	</a>
		// </dd>
		var publisher_video=$(".global-publisher-selector-video");
		console.log(publisher_video);
		var dd="<dd class='global-publisher-selector-voice'>";
		var style="overflow: hidden;"+
					...
					"width: 18px;"+
					"height: 16px;"+
					"background:url("+voice_img+")";
		
		var a="<a class='global-publisher-voice-trigger' "+
				"style='"+style+"'"+
				"href='javascript:;' title='语音'>"+
			 	" </a>";
		var final_html=dd+a+"</dd>";
			publisher_video.after(final_html);
			var voice_btn=$(".global-publisher-selector-voice");
